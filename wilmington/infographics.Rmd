...
While at first sight, this might seem neglibile at an individual,
...
As food rots in a landfill, it emits **_methane_, a greenhouse gas 28 to 36 times more potent than the carbon** that comes out of passenger vehicles.
...
While it is possible to offset the harm of these emissions and leaks through organics recycling, composting, and anaerobic digestion, **the best way to reduce these emissions and leaks is to waste less food in the first place**.
