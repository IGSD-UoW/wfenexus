...
This is a combination of the two previous slides:


THE TWO DATAFRAMES USE DIFFERENT UNITS SO THEY CANNOT BE COMBINED LIKE THAT!
uSE SAME UNITS, EITHER PERCENT OR TONNES.


```{r}
spf_management_combined <- spf_management %>% 
  bind_rows(wasted_food)
