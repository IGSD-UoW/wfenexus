...
# Adds five stars rating.
rating_stars <- function(rating, icon = "star", color = "orange", max_rating = 5) {
  if (!is.na(rating)) {
  ...
  reactable(
    ...
    columns = list(
      ...
      parent_satisfaction = colDef(
        ...
        aggregate = "mean",
        format = colFormat(digits = 1),
        cell = function(value) rating_stars(value, color = color_energy)
      ),
      health = colDef(
        name = "Perceived Health",
        aggregate = "mean",
        format = colFormat(digits = 1),
        cell = function(value) rating_stars(value, icon = "heart", color = color_food)
      )
    )
  )
)
