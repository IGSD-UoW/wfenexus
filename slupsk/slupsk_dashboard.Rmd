...
dishes_raw <- read_csv("data-raw/dishes.csv")

dishes_df <- ci_dishratings(dishes_raw, dishrating)
...
bar_chart <- function(label, width = "100%", height = "16px", fill = "#00bfc4", background = "#e1e1e1") {
  label <- format(label, big.mark = ",")
  label <- format(label, width = 6, justify = "right") 
  bar <- div(
    class = "bar-chart",
    style = list(background = fill, width = width, height = height))
  chart <- div(
    style = list(flexGrow = 1, marginLeft = "8px", background = background), bar)
  div(
    class = "bar-cell", 
    style = list(display = "flex", alignItems = "center"), 
    span(class = "number",label), chart)
}

bar_cell = function(value, variable, color, background = "#e1e1e1") {
  if (!is.na(value)) {
  ...
  reactable(
    ...
    columns = list(
      ...
      world_green = colDef(
        ...
        cell = function(value) {
          bar_cell(value, df$world_green, color_wfp_green)
        }),
      world_blue = colDef(
        # name = "Blue", 
        align = "right",
        ...
        cell = function(value) {
          bar_cell(value, df$world_blue, color_wfp_blue)
        }),
      world_grey = colDef(
        # name = "Grey", 
        ...
        align = "right",
        cell = function(value) {
          bar_cell(value, df$world_grey, color_wfp_grey)
        }),
      world_total = colDef(
        # name = "Total", 
        ...
        align = "right",
        cell = function(value){
          bar_cell(value, df$world_total, color_water, "#e1e1e1")
        }),
      country_green = colDef(name = "Green", align = "right",
         cell = function(value){
          bar_cell(value, df$country_green, color_wfp_green)
        }),
      country_blue = colDef(name = "Blue", align = "right",
        cell = function(value) {
          bar_cell(value, df$country_blue, color_wfp_blue)
        }),
      country_grey = colDef(name = "Grey", align = "right",
        cell = function(value) {
          bar_cell(value, df$country_grey, color_wfp_grey)
        }),
      country_total = colDef(name = "Total", align = "right",
        cell = function(value) {
          bar_cell(value, df$country_total, color_water)
        }),
