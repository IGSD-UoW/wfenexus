...
g <- ggplot(ingredients_used_df, 
  ...
  labs(title = "Ingredients' usage vs. water footprint",
       subtitle = "This is a subtitle",
       x = "Total weight (g)",
       y = "Avg. Water Footprint (m3/Ton)",
       color = "Type of food",
       size = NULL,
       alpha = NULL)
...
p <- dishes_df %>% 
  ...
  labs(subtitle = "Based on the average ratings made by parents and children", 
       x = "Parents", y = "Children", color = "Kindergarten") +
